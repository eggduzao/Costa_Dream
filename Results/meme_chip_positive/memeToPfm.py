...
# Input
top = 5
inLocList = glob("/Users/egg/Projects/Costa_Dream/exp/meme_chip_positive/results/*/")
outLoc = "/Users/egg/Projects/Costa_Dream/exp/motifs/pfm_meme_positive/"
...
for inLoc in inLocList:
  ...
  for i in range(0,min(top,len(resTable))):
    ...
    outputFileName = outLoc+".".join(["POS",factor,str(i+1),resTable[i][0],resTable[i][1],"pwm"])
