...
# Input
inLoc = "/hpcwork/izkf/projects/dream_tfbs/exp/full_mpbs_footprints_tc/ladder/"
outLoc = "/hpcwork/izkf/projects/dream_tfbs/exp/ladder/results2/"

# Loop
#inFileList = [e for e in inLoc+"*.tab"]
...
python ladder2.py /hpcwork/izkf/projects/dream_tfbs/exp/full_mpbs_footprints_tc/ladder/L.ARID3A.K562.tab /hpcwork/izkf/projects/dream_tfbs/exp/ladder/results2/L.ARID3A.K562.tab
gzip L.ARID3A.K562.tab
scp eg474423@$CLUSTER:/hpcwork/izkf/projects/dream_tfbs/exp/ladder/results2/L.ARID3A.K562.tab.gz /home/egg/Desktop/
