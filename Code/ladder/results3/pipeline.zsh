...
# Evaluating scores
#python /home/egg/eg474423_Projects/trunk/Dream/exp/ladder/results3/ladder3.py $inFileName $outFileName
python /work/ig440396/project/Dream/exp/ladder/results3/ladder3.py $inFileName $outFileName

# Compressing
gzip -c $outFileName > $outFileName".gz"
