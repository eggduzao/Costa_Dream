...
# Retrieve Footprints
biasTable=$biasLoc$cell"_F.txt,"$biasLoc$cell"_R.txt"
organism="hg19"
outputLocation=$outLoc$cell"/"
inputMatrix=$matrixLoc$cell".em"
mkdir -p $outputLocation
rgt-hint --bias-table=$biasTable --organism=$organism --output-location=$outputLocation $inputMatrix
