...
dnasePeakLoc = "/hpcwork/izkf/projects/dream_tfbs/exp/dnase/"
outLoc = "/work/eg474423/Costa_Dream/exp/meme_chip_negative/results/"
...
for factor in factorList:
  ...
  clusterCommand += factor+" "+cellList+" "+chipHalfExt+" "+dnaseHalfExt+" "+totalPeaks+" "+memeDBFileName+" "+genomeFileName+" "+tfPeakLoc+" "+dnasePeakLoc+" "+outLoc
  ...
  #sys.stdout.flush()
  #clusterCommand = "./pipeline.zsh "+factor+" "+cellList+" "+chipHalfExt+" "+dnaseHalfExt+" "+totalPeaks+" "+memeDBFileName+" "+genomeFileName+" "+tfPeakLoc+" "+dnasePeakLoc+" "+outLoc
  #os.system(clusterCommand)
  #sys.stdout.flush()
  #print "----------------------------------------------------------\n\n"
  #sys.stdout.flush()
